...
router.get('/reports/due-ledger', reports.dueLedger);
router.get('/reports/sales', reports.sales);
router.post('/settings/expense-categories', domain.manageExpenseCategory);
router.get('/parties/summary', domain.partySummary);
router.get('/parties/:id/detail', domain.partyDetail);
